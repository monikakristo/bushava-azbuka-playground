  ...
  return (
    <footer className="bg-grape/10 px-6 py-10 text-center">
      ...
      <div className="mt-4 flex justify-center gap-3 text-sm">
        <button className="rounded-full bg-white px-4 py-1 font-bold text-foreground shadow-sm">
          🇲🇰 Македонски
        </button>
        <button className="rounded-full px-4 py-1 font-bold text-muted-foreground hover:text-foreground">
          🇬🇧 English
        </button>
      </div>
